...
const getVariantClasses = (variant: ButtonVariant): string => {
  switch (variant) {
    ...
    case 'ghost':
      return 'bg-transparent hover:bg-gray-100 text-gray-700 dark:text-gray-200 dark:hover:bg-gray-700 focus:ring-gray-500';
  }
};
...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      className={`inline-flex items-center justify-center font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors ${getVariantClasses(
        variant
